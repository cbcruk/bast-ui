...
export class MenuPositioner extends MenuPart {
  ...
  private activate(root: MenuContextValue): void {
    if (this.teardown) {
      return
    }
  ...
  private reposition(root: MenuContextValue): void {
...
void MenuPositioner.define({
  name: 'bast-menu-positioner',
  shadowOptions: null,
})

declare global {
  interface HTMLElementTagNameMap {
    'bast-menu-positioner': MenuPositioner
  }
}
