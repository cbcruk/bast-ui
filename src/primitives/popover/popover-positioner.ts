...
import { getFocusable } from '../../utilities/focus.ts'
...
export class PopoverPositioner extends PopoverPart {
  ...
  private activate(root: PopoverContextValue): void {
    if (this.teardown) {
      return
    }
  ...
  private reposition(root: PopoverContextValue): void {
...
void PopoverPositioner.define({
  name: 'bast-popover-positioner',
  shadowOptions: null,
})

declare global {
  interface HTMLElementTagNameMap {
    'bast-popover-positioner': PopoverPositioner
  }
}
